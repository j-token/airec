...
`airec` is a Windows-only command-line screen recorder designed for AI agents that need to create evidence of computer-use work. It records monitors or unobscured application windows to video-only H.264 fragmented MP4, can burn mouse-click ripples into frames, and exposes machine-readable JSONL lifecycle events.
